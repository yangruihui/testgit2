			              	...
			              	<table id="jobgroup_list" class="table table-bordered table-striped display" width="100%" >
				                <thead>
					            	<tr>
                                        ...
                                        <th name="executorType">执行器类型</th>
                                        <th name="databaseParamList">数据库配置信息</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        ...
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">执行器类型</label>
                            <div class="col-sm-10">
                                <input type="radio" name="executorType" value="0" checked />系统定时任务
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="executorType" value="1" />数据库定时任务
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 contro-lable">数据库配置信息*</label>
                            <div class="col-sm-10">
                                <textarea class="textarea form-control" name="databaseParam" placeholder="请输入数据库配置信息：&#10; driver:驱动类&#10; url:地址&#10; username:用户名&#10; password:密码" maxlength="512" readonly="readonly" style="background-color:#eee; width: 100%; height: 100px; font-size: 14px; line-height: 15px; border: 1px solid #dddddd; padding: 5px;"></textarea>
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                ...
                <div class="modal-body">
                    <form class="form-horizontal form" role="form" >
                        ...
                        <div class="form-group">
                            <label for="lastname" class="col-sm-2 control-label">执行器类型</label>
                            <div class="col-sm-10">
                                <input type="radio" name="executorType" value="0" />系统定时任务
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="executorType" value="1" />数据库定时任务
                            </div>
                        </div>
