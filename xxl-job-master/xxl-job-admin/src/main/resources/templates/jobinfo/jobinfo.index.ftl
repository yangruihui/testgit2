			              	...
			              	<table id="job_list" class="table table-bordered table-striped" width="100%" >
				                <thead>
					            	<tr>
                                        ...
                                        <th name="triggerNextDate">下次调度时间</th>
                                        <th name="triggerLastDate">上次调度时间</th>
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="textarea form-control" name="executorParam" placeholder="${I18n.system_please_input}${I18n.jobinfo_field_executorparam}" maxlength="4000" style="height: 63px; line-height: 1.2;"></textarea>
                        </div>
                    </div>
